...
declare module "game/key_action_mapper" {
    ...
    export class Keybinding {
         ...
         */
        constructor(keyMapper: KeyActionMapper, app: Application, { keyCode, builtin, repeated, modifiers }: {
            keyCode: number;
...
declare module "game/components/static_map_entity" {
    export class StaticMapEntityComponent extends Component {
        static getSchema(): {
            ...
            code: import("savegame/serialization_data_types").TypePositiveIntegerOrString;
        };
        /**
         *
         * @param {object} param0
...
declare module "mods/mod" {
    export class Mod {
        ...
        constructor({ app, modLoader, meta, settings, saveSettings }: {
            app: Application;
            modLoader: ModLoader;
            meta: import("./modloader").ModMetadata;
            settings: any;
        ...
        signals: {
            [x: string]: any;
            appBooted: import("core/signal").Signal;
        ...
        modInterface: import("mods/mod_interface").ModInterface;
        settings: any;
        saveSettings: () => Promise<void>;
        init(): void;
        get dialogs(): import("game/hud/parts/modal_dialogs").HUDModalDialogs;
    }
    import { Application } from "application";
...
declare module "mods/mod_interface" {
    /**
    ...
    export class ModInterface {
         ...
         * @param {boolean=} param0.builtin
         */
        registerIngameKeybinding({ id, keyCode, translation, modifiers, repeated, builtin, handler, }: {
            id: string;
            keyCode: number;
            translation: string;
            repeated?: boolean | undefined;
         ...
         */
        replaceMethod<C extends {
            new (...args: any[]): any;
            prototype: any;
        }, P extends C["prototype"], M extends keyof P, O extends (args_0: any, ...args_1: any[]) => ReturnType<P[M]>>(classHandle: C, methodName: M, override: (this: InstanceType<C>, args_0: P[M], args_1: Parameters<O>) => ReturnType<O>): void;
        /**
         ...
         */
        runBeforeMethod<C_1 extends {
            new (...args: any[]): any;
            prototype: any;
        }, P_1 extends C_1["prototype"], M_1 extends keyof P_1, O_1 extends (args_0: any, ...args_1: any[]) => ReturnType<P_1[M_1]>>(classHandle: C_1, methodName: M_1, executeBefore: (this: InstanceType<C_1>, ...args: Parameters<O_1>) => ReturnType<O_1>): void;
        /**
         ...
         */
        runAfterMethod<C_2 extends {
            new (...args: any[]): any;
            prototype: any;
        }, P_2 extends C_2["prototype"], M_2 extends keyof P_2, O_2 extends (args_0: any, ...args_1: any[]) => ReturnType<P_2[M_2]>>(classHandle: C_2, methodName: M_2, executeAfter: (this: InstanceType<C_2>, ...args: Parameters<O_2>) => ReturnType<O_2>): void;
        /**
         *
         * @param {Object} prototype
         * @param {({ $super, $old }) => any} extender
         */
        extendObject(prototype: any, extender: ({ $super, $old }: {
            $super: any;
            $old: any;
        }) => any): void;
        /**
         ...
         * @param {({ $super, $old }) => any} extender
         */
        extendClass(classHandle: any, extender: ({ $super, $old }: {
            $super: any;
            $old: any;
        }) => any): void;
        /**
         ...
         */
        registerBuildingTranslation(buildingIdOrClass: string | (new () => MetaBuilding), variant: string, { name, description, language }: {
            name: string;
            description: string;
...
declare module "game/logic" {
    ...
    export class GameLogic {
         ...
         */
        checkCanPlaceEntity(entity: Entity, { allowReplaceBuildings, offset }: {
...
declare module "core/background_resources_loader" {
    export class BackgroundResourcesLoader {
         ...
         */
        loadAssets({ sprites, sounds, atlas, css }: {
            sprites: string[];
            sounds: string[];
...
declare module "platform/ad_providers/crazygames" {
...
declare module "game/hud/parts/next_puzzle" {
